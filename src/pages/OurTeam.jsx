      ...
      <button className="back-to-menu" onClick={() => navigate("/")}>
        ...
        <div className="team-members">
          ...
          <div className="team-member">
            <h2>מייקל רומאנו</h2>
            <p>
              מנהל המשרד ויועץ נדל"ן עם מומחיות חסרת פשרות בניהול עסקאות מורכבות.
              מייקל לא רק סוגר עסקאות—הוא יוצר הזדמנויות. עם שילוב של אסטרטגיית
              שיווק דיגיטלי מתקדמת, חשיבה מחוץ לקופסה, ורשת קשרים חובקת עולם, הוא
              מביא לשולחן את כל מה שצריך כדי להשיג את העסקה הנכונה עבור הלקוח
              הנכון.
            </p>
            <p>
            ...
            <p>
              <strong>משפט מוביל:</strong> "מכירת נכס היא לא רק עסקה – זו יצירת
              אסטרטגיה חכמה שמובילה למקסימום תוצאה."
            </p>
          </div>
          ...
          <div className="team-member">
            <h2>גלי ג'ינוריה</h2>
            <p>
              כלכלנית ויועצת פיננסית, מנהלת קשרי לקוחות עם ניסיון עשיר בשוק ההון
              ובתחום הנדל"ן. גלי היא לא רק מנהלת קשרי לקוחות—היא מנוע צמיחה. היא
              בונה מערכות יחסים שמחזיקות שנים, מומחית ביצירת תהליכים יעילים לגיוס
              קונים ומוכרים, מתאימה את הקונים לנכסים המדויקים להם תוך התאמה מדויקת
            ...
            <p>
              <strong>משפט מוביל:</strong> "אצלי כל לקוח הוא שותף לדרך – והדרך
              הזו מובילה לתוצאות."
            </p>
          </div>
        </div>
